                    ...
                    ?>
                        ...
                        <div class="dropdown" style="display: inline-block;">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                                <li><a class="dropdown-item" href="logout.php" id="admin-logout"><?php echo $row['username'] ?> Logout </a></li>
                                <li><a class="dropdown-item" > Welcome <?php echo $row['username'] ?> </a></li>
                                <li><a class="dropdown-item" href="accountInfo.php?loggedin=true"> Your account info </a></li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="admin-menu">
                        <?php
                        if ($_SESSION['role'] == 1) {
                            echo '<li> <a href="showCategory.php">Category</a> </li>';
                        }
                        ?>
                        <li> <a href="users.php">Users</a> </li>
                        <li> <a href="showThreads.php">Threads</a> </li>
                        <li> <a href="showComments.php">Comments</a> </li>
                    </ul>
                </div>
            </div>
        </div>
